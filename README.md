...
1 - Сделано на странице "Новости"
2 - Сделано на странице "Книги"
3 - Сделано на странице "Книги". При наведении на книгу изображение переворачивается на другую сторону, и там написано описание книги.
4 - Сделано на странице "Хочу стать волшебником". Сделана форма с вопросами, которая по кнопке Отправить отправляет POST запрос на сервер.
5 - Сделано на странице "Хочу стать волшебником". Происходит проверка на имя, дату и обязательный ответ на вопрос.
6 - Сделано на странице "Хочу стать волшебником". Отправка асинхонного запроса на сервер с полученными данными для того, чтобы сервер посчитал по баллам результат и отправил выбранный факультет обратно на клиент. 
